...
- 매번 SSH/WinRM 연결을 생성합니다.
- Agent 방식보다 네트워크 사용량이 높습니다.

❌ **응답 속도**

- 연결 설정 시간이 필요합니다.
- Agent 방식보다 느린 응답이 발생할 수 있습니다.

❌ **기능 제한**

- 일부 고급 기능을 사용할 수 없습니다.
- 복잡한 작업 수행이 어렵습니다.
...
- 계정 정보를 MDRM에 저장해야 합니다.
- 계정 변경 시 일일이 업데이트해야 합니다.

🔒 **네트워크 노출**

- SSH/WinRM 포트를 오픈해야 합니다.
- 방화벽 설정이 필요합니다.
