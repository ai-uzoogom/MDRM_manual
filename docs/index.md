...
### [📘 PART 1 - MDRM 설치 및 환경 구성](part1/MDRM_PART1_학습_안내.md)
인프라 사양 확인부터 Docker/Podman 설치, 그리고 MDRM 엔진 구동까지의 과정을 다룹니다.

### [🔧 PART 2 - 운영 환경 및 자원 관리](part2/MDRM_PART2_학습_안내.md)
Agent 설치부터 시스템 그룹화, 워크플로우 기초 구성을 학습하여 운영 체계를 구축합니다.

### [🔄 PART 3 - 워크플로우 설계 및 고도화](part3/MDRM_PART3_학습_안내.md)
3단계 로직 기반의 컴포넌트 설계와 계층적 워크플로우 구성을 통해 고도화된 자동화를 구현합니다.

### [⚠️ PART 4 - 실전 실습 및 트러블슈팅](part4/MDRM_PART4_학습_안내.md)
