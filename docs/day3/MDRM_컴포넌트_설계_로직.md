...
### **3.1 성공/실패 조건 설정**
컴포넌트의 결과는 단순히 리턴코드(`0` 또는 `1`)로만 판단하지 않고, 결과 텍스트 내의 **특정 키워드**를 통해 판단할 수 있습니다.

*   **성공 키워드**: `Started successfully`, `Status: RUNNING`
*   **실패 키워드**: `ERROR`, `Failed`, `Address already in use`
